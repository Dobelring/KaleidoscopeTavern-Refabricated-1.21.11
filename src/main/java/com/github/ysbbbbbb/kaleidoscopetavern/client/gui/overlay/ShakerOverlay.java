...
public class ShakerOverlay {
    private static final ResourceLocation IMG = ResourceLocation.fromNamespaceAndPath(KaleidoscopeTavern.MOD_ID, "textures/gui/shaker.png");
    private static final ResourceLocation ICON = ResourceLocation.fromNamespaceAndPath(KaleidoscopeTavern.MOD_ID, "gui/rhombus");
