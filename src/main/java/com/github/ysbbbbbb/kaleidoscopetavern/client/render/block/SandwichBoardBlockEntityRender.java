...
public class SandwichBoardBlockEntityRender extends TextBlockEntityRender<SandwichBoardBlockEntity> {
    private static final float TEXT_SCALE = 0.01f;
    private static final int LINE_HEIGHT = 10;
    private static final int MAX_LINES = 8;

    public SandwichBoardBlockEntityRender(BlockEntityRendererProvider.Context context) {
        super(context);
    }
