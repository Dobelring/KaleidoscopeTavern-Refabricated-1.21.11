...
public class IncenseSuspendedParticle extends SingleQuadParticle {
    protected IncenseSuspendedParticle(ClientLevel level, SpriteSet sprites, double x, double y, double z,
                                       double xSpeed, double ySpeed, double zSpeed, RandomSource randomSource) {
        super(level, x, y - 0.125, z, xSpeed, ySpeed, zSpeed, sprites.get(randomSource));
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level,
            ...
            return new IncenseSuspendedParticle(level, this.sprites, x, y, z, 0, -0.8, 0, randomSource);
        }
    }
}
