...
public final class ModRecipes {
    ...
    public static final RecipeType<ShakerRecipe> SHAKER_RECIPE = simple(new ResourceLocation(KaleidoscopeTavern.MOD_ID, "shaker"));
    ...
    public static void registerRecipes() {
        ...
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, new ResourceLocation(KaleidoscopeTavern.MOD_ID, "shaker"), SHAKER_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, new ResourceLocation(KaleidoscopeTavern.MOD_ID, "shaker"), SHAKER_RECIPE);
    }
