...
public final class ModRecipes {
    ...
    public static final RecipeSerializer<ShakerRecipe> SHAKER_SERIALIZER = new RecipeSerializer<>(ShakerRecipeSerializer.codec(), ShakerRecipeSerializer.streamCodec());
