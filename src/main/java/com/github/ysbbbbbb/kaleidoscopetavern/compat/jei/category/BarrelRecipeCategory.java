...
public class BarrelRecipeCategory implements IRecipeCategory<RecipeHolder<BarrelRecipe>> {
    ...
    @Override
    public void draw(@NonNull RecipeHolder<BarrelRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
    ...
    public void setRecipe(@NonNull IRecipeLayoutBuilder builder, RecipeHolder<BarrelRecipe> holder, @NonNull IFocusGroup focuses) {
        ...
        ItemStack outputStack = recipe.result().getDefaultInstance().copyWithCount(16);
