...
public class PressingTubCategory implements IRecipeCategory<RecipeHolder<PressingTubRecipe>> {
    ...
    @Override
    public void draw(RecipeHolder<PressingTubRecipe> holder, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
