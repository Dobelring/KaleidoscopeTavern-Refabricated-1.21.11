...
public class BarrelServerRecipe implements ReliableServerRecipe {
    public static final ReliableServerRecipeType<BarrelServerRecipe> TYPE = ReliableServerRecipeType.register(
            Identifier.fromNamespaceAndPath(KaleidoscopeTavern.MOD_ID, "barrel"),
            () -> new BarrelServerRecipe(null, List.of(), null)
    );
    private ItemStackTemplate result;
    private List<Ingredient> ingredients;
    private Ingredient carrier;

    public BarrelServerRecipe(ItemStackTemplate result, List<Ingredient> ingredients, Ingredient carrier) {
        this.result = result;
