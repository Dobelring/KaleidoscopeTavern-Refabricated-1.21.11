...
public class ShakerRecipeCategory implements IRecipeCategory<ShakerRecipe> {
    ...
    private static final ResourceLocation BG = new ResourceLocation(KaleidoscopeTavern.MOD_ID, "textures/gui/jei/shaker.png");
    ...
    @Override
    public @NotNull RecipeType<ShakerRecipe> getRecipeType() {
        return TYPE;
    }
