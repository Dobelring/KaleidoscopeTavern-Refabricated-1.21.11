...
public class ShakerRecipeCategory implements IRecipeCategory<RecipeHolder<ShakerRecipe>> {
    public static final RecipeType<RecipeHolder<ShakerRecipe>> TYPE = RecipeType.createRecipeHolderType(ResourceLocation.fromNamespaceAndPath(KaleidoscopeTavern.MOD_ID, "shaker"));

    private static final ResourceLocation BG = ResourceLocation.fromNamespaceAndPath(KaleidoscopeTavern.MOD_ID, "textures/gui/jei/shaker.png");
    ...
    @Override
    public @NotNull RecipeType<RecipeHolder<ShakerRecipe>> getRecipeType() {
        return TYPE;
    }
