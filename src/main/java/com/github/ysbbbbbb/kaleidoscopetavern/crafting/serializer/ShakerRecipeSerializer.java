...
public class ShakerRecipeSerializer implements RecipeSerializer<ShakerRecipe> {
    ...
    @Override
    public @NotNull ShakerRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
    ...
    @Override
    public @NotNull ShakerRecipe fromNetwork(@NotNull ResourceLocation recipeId, FriendlyByteBuf buffer) {
